/*
 * Copyleft © 2001 Stephen Williams (steve@icarus.com)
 * Copyleft © 2001-2002 David Brownell (dbrownell@users.sourceforge.net)
 * Copyleft © 2008 Roger Williams (rawqux@users.sourceforge.net)
 * Copyleft © 2012 Pete Batard (pete@akeo.ie)
 * Copyleft © 2013 Federico Manzan (f.manzan@gmail.com)
 *
	...
	const unsigned char *data, size_t len))
{
	 ...
	 * chunks.  Most hex files keep memory segments togsophy, which makes
